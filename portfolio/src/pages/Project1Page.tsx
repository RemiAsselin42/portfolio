  ...
  <ProjectTemplate
    ...
    projectDescription={
      <>
        ...
        <strong>master en web design</strong> pour septemhre 2025.
        <hr />
        ...
        collaborant avec des <strong>associations du secteur social</strong> et
        développant des compétences en <strong>gestion entrepreneuriale</strong>
        .
        <hr />
